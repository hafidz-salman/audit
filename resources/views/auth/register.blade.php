        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="bg-gradient-to-br from-blue-600 to-purple-700 p-8 md:w-1/2 text-white">
                ...
                <div class="mb-8 text-center">
                    <h2 class="text-xl font-semibold mb-4">Bergabung dengan Kami</h2>
                    <p class="text-blue-100 text-sm leading-relaxed">
                        Daftarkan akun Anda untuk mengakses portal akademik dan nikmati kemudahan dalam mengelola informasi akademik.
                    </p>
                </div>
                ...
                <div class="space-y-3">
                    <div class="flex items-center text-sm">
                        ...
                        <span>Akses Data Mahasiswa</span>
                    </div>
                    <div class="flex items-center text-sm">
                        <i class="fas fa-check-circle text-green-300 mr-3"></i>
                        <span>Jadwal Kuliah Terintegrasi</span>
                    </div>
                    <div class="flex items-center text-sm">
                        <i class="fas fa-check-circle text-green-300 mr-3"></i>
            ...
            <div class="p-8 md:w-1/2">
                <div class="max-w-sm mx-auto">
                    ...
                    <p class="text-gray-600 text-sm mb-6">Lengkapi data berikut untuk membuat akun</p>
