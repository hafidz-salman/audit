        ...
        <table class="w-full">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 text-sm font-medium text-gray-900">{{ $validasi->kinerja->indikator->nama_indikator ?? 'N/A' }}</td>
                    <td class="px-6 py-4 text-sm text-gray-900">{{ $validasi->validator->name ?? 'N/A' }}</td>
                    <td class="px-6 py-4 text-sm text-gray-900">{{ $validasi->tanggal_validasi }}</td>
